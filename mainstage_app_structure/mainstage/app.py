...
# # Rotate spotlight if 24 hours passed
# rotate_spotlight()
...
#     <li>✨ Instructions:</li>
#     <li>👤 Go to <b>Profile</b> page and create your identity.</li>
#     <li>🔧 Edit your profile anytime from the <b>Profile</b> page.</li>
#     <li>🗳️ Visit <b>Vote</b> to support your favorite profile.</li>
#     <li>🌟 The most voted user is crowned the spotlight for 24 hours!</li>
# </ul>
# </div>
...
#                     image_path = uploads_dir / f"{username.replace(' ', '_')}_{image.name}"
#                     with open(image_path, "wb") as f:
#                         f.write(image.read())
...
# ✅ Automatically rotate spotlight
rotate_spotlight()
